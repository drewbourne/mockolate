package mockolate.runner
{
	...
	/**
	 * MockMetadata is used only by the MockolateRunner. 
	 * 
	...
	public class MockMetadata
	{
		...
		private function parseInject (argument : MetaDataArgument) : Boolean
		{
			...
			if (injectable)
			{
				...
				{
					throw new Error(substitute(
						  "Cannot inject mock of type '{}' into property '{}'; " 
						+ "constructor arguments are required! " 
						+ "Please set inject='false' and manually create the mock " 
						+ "in the [Before] for this test class.", 
						this.type,  this.name));
				}
			}
